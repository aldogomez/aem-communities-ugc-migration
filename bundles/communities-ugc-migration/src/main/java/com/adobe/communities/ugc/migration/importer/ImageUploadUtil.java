...
public class ImageUploadUtil {
     ...
     */
    public static String importImage(final ResourceResolver resourceResolver, final String input) {
            ...
            while ((index = StringUtils.indexOf(modified, SRC_ELEMENT, startPos)) >= 0) {
                ...
                if (imgStartPos > 0) {
                    ...
                    if (imgEndPos > 0) {
                        ...
                        String importedImgUrl = importImageToJcr(resourceResolver, imgUrl);
